            ...
            <div class="chapter-list">
                <div class="chapter-item">
                    ...
                    <div class="chapter-links">
                        ...
                        <a href="../B2/Constructions_elementaires/premiers_pas_csharp" class="chapter-link">Fiche d'exercices sur les types de base</a>
                        <a href="../B2/Programmation_Orientee_Objet/introduction_poo_csharp" class="chapter-link">Cours sur la Programmation Orientée Objet</a>
                        <a href="../B2/Programmation_Orientee_Objet/exercices_poo_csharp" class="chapter-link">Fiche d'exercices sur la programmation orientée objet</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="category-card category-security">
            ...
            <div class="chapter-item">
                ...
                <div class="chapter-links">
                   ...
                   <a href="../B3/injections_sql" class="chapter-link">📚 Injections SQL</a>
                </div>
            </div>
