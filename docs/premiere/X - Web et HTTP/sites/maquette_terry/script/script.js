document.addEventListener('DOMContentLoaded', function() {
    ...
    if (tableauImage) {
        const tableauOriginal = 'images/original.jpg';
        const tableauRenard = 'images/modifie.jpg';

        // Afficher le tableau modifié par défaut
        tableauImage.src = tableauRenard;
        
        // Quand la souris passe sur l'image → montrer l'original
        tableauImage.addEventListener('mouseover', function() {
            tableauImage.src = tableauOriginal;
        });
        
        // Quand la souris quitte l'image → revenir au tableau modifié
