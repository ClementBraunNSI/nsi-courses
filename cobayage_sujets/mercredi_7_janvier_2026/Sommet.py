...
class Sommet:
    ...
    def distance(self, objet):
        return sqrt(pow((self.x -objet.x),2)+pow((self.y-objet.y),2)+pow((self.z-objet.z),2))

#############################################################################
# Écrire le code de la methode distance de la question 1                    #
#############################################################################

#############################################################################
# Programme votre méthode de la question 1                                  #
#############################################################################
s1 = Sommet(0, 0, 0)
s2 = Sommet(3, 4, 0)
