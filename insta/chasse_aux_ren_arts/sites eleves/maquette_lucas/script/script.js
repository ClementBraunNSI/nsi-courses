...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (quizForm && resultatQuiz) {
        quizForm.addEventListener('submit', function(event) {
            ...
            // Récupérer les réponses
            const reponse1 = document.querySelector('input[name="1. Quel est le rôle symbolique du ballon dans chacune des œuvres ?"]:checked');
            const reponse2 = document.querySelector('input[name="2. Comment les deux œuvres utilisent-elles des personnages (un renard et une petite fille) pour transmettre un message émotionnel ou social ?"]:checked');
