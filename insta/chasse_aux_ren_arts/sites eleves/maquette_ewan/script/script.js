...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const tableauImage = document.getElementById('tableauImage');
    if (tableauImage) {
        const tableauOriginal = 'images/fallenangel.jpg';
        const tableauRenard = 'images/fallenangelfox.png';
        
        
        // Quand la souris passe sur l'image
        tableauImage.addEventListener('mouseover', function() {
            tableauImage.src = tableauRenard; // Afficher l'image avec le renard
            
        });
        
        // Quand la souris quitte l'image
        tableauImage.addEventListener('mouseout', function() {
            tableauImage.src = tableauOriginal; // Revenir à l'image originale
        });
    }
